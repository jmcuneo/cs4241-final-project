    ...
    readonly body: {
        ...
        readonly properties: {
            ...
            readonly blend: {
                ...
                readonly description: "Select one of the appearance types from the dropdown list (screen is chosen if left blank). The options are as follows:\n  * normal\n  * screen\n  * overlay\n  * multiply\n  * darken\n  * lighten\n  * add\n\nDefault: `screen`";
            };
            readonly mask: {
                readonly type: "string";
                readonly enum: readonly ["lace1", "lace2", "lace3", "lace4", "shdw2", "shdw17", "rpl3", "rpl5", "prsm3", "prsm9", "prsm10"];
                readonly description: "Select one of the mask types from the dropdown list. The options are as follows:\n  * lace1\n  * lace2\n  * lace3\n  * lace4\n  * shdw2\n  * shdw17\n  * rpl3\n  * rpl5\n  * prsm3\n  * prsm9\n  * prsm10\n";
            };
            readonly opacity: {
                readonly type: "integer";
                readonly minimum: 0;
    ...
    readonly body: {
        ...
        readonly properties: {
            ...
            readonly blend: {
                ...
                readonly enum: readonly ["normal", "screen", "overlay", "multiply", "darken", "lighten", "add"];
                readonly default: "screen";
                readonly description: "Select one of the appearance types from the dropdown list (it will be _screen_ if left blank). The options are as follows.\n  * normal\n  * screen\n  * overlay\n  * multiply\n  * darken\n  * lighten\n  * add\n\nDefault: `screen`";
            };
            readonly mask: {
                readonly type: "array";
                readonly minItems: 1;
                readonly description: "Select up to 10 mask types from the list by holding down Ctrl. The options are as follows\n  * lace1\n  * lace4\n  * shdw2\n  * shdw17\n  * fold5\n  * fold9\n  * rpl3\n  * rpl5\n  * prsm3\n  * prsm9\n  * prsm10\n";
                readonly items: {
                    readonly type: "string";
                    readonly enum: readonly ["lace1", "lace2", "lace3", "lace4", "shdw2", "shdw17", "rpl3", "rpl5", "prsm3", "prsm9", "prsm10"];
                };
    ...
    readonly body: {
        ...
        readonly properties: {
            ...
            readonly upscale_factor: {
                readonly type: "string";
                readonly enum: readonly ["x2", "x4", "x6", "x8"];
    ...
    readonly body: {
        ...
        readonly properties: {
            ...
            readonly downscale_to: {
                ...
                readonly description: "Large images can be downscaled. Use -1 to turn off downscaling. Otherwise the image is scaled by 0.5 until max(width, height) < downscale_to.";
            };
        };
        readonly $schema: "http://json-schema.org/draft-04/schema#";
    };
